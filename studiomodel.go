...
import (
	...
	"github.com/aoisensi/go-studiomodel/mdl"
	"github.com/aoisensi/go-studiomodel/vtx"
	"github.com/aoisensi/go-studiomodel/vvd"
)
...
func LoadFromDisc(mdlName string) (*Model, error) {
	if !strings.HasSuffix(mdlName, ".mdl") {
		return nil, fmt.Errorf("studiomodel: mdlName must end with .mdl")
	}
